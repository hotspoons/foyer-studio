#!/usr/bin/env python3
"""
Rebuild web/ui-sprunkadoo/sprunki-assets.json from the canonical
project.json shipped with the OG sprunki TurboWarp/Scratch package.

Why this exists
---------------
The original manifest in web/ui-sprunkadoo/sprunki-assets.json was
...
EXISTING_MANIFEST = REPO / "web/ui-sprunkadoo/sprunki-assets.json"
