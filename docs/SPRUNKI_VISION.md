...
- 7 sprunkis is the default cast count, but the stage can hold
  more — the upper bound is "what fits without things piling on
  top of each other," not a hard slot count.
