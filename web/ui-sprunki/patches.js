 ...
 * @property {string} emoji            — palette + costume fallback when art pack absent
...
export const PATCHES = [
  ...
  {
    id: "drum-kit", label: "Drum Kit", emoji: "🥁",
  ...
  {
    id: "raddy-snare", label: "Snare", emoji: "🥁",
  ...
  {
    id: "fun-bot-break", label: "Break", emoji: "🤖",
    color: "#ffc633", mode: "drum",
    instrument_uri: AVLDRUMS_RED_ZEPPELIN, instrument_uri_fallbacks: DRUM_FALLBACKS,
    gm_program: 0, gm_channel: 9,
    sprunki_id: "fun-bot",
    rows: [
      // Tom-and-clap "break" pattern that layers cleanly with kick+snare.
      { id: "tom",  label: "Tom",  pitch: 47, color: "#ffc633", default_loop: [6, 14] },
      { id: "clap", label: "Clap", pitch: 39, color: "#ffe9b3", default_loop: [4, 12] },
    ],
  },
  {
    id: "vineria-shaker", label: "Shaker", emoji: "🌿",
  ...
  {
    id: "brud-glitch", label: "Vox Glitch", emoji: "🗣",
  ...
  {
    id: "garnold-arp", label: "Arpeggio", emoji: "🌟",
  ...
  {
    id: "owakcx-riser", label: "Riser", emoji: "🚀",
  ...
  {
    id: "sky-musicbox", label: "Music Box", emoji: "🎵",
  ...
  {
    id: "mr-sun-piano", label: "Piano", emoji: "🌞",
  ...
  {
    id: "durple-brass", label: "Brass", emoji: "🎺",
  ...
  {
    id: "mr-tree-organ", label: "Organ", emoji: "🌳",
  ...
  {
    id: "simon-square", label: "Square", emoji: "🟡",
  ...
  {
    id: "tunner-whistle", label: "Whistle", emoji: "🎶",
  ...
  {
    id: "mfc-ai",  label: "AI Sing", emoji: "🖥",
    color: "#222222", mode: "pitched",
    instrument_uri: GMSYNTH, instrument_uri_fallbacks: SYNTH_FALLBACKS,
    gm_program: 85, gm_channel: 0,  // GM Lead 6 (voice)
    sprunki_id: "mr-fun-computer",
    rows: [
      { id: "tonic", label: "Tonic", scale_degree: 0, octave_offset: 1, color: "#222222", default_loop: [0, 8] },
    ],
  },
  {
    id: "wenda-hey",  label: "Hey!", emoji: "🎤",
  ...
  {
    id: "pinki-choir", label: "F Choir", emoji: "🎀",
  ...
  {
    id: "jevin-male-choir", label: "M Choir", emoji: "🎼",
